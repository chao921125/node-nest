...
hoistedDependencies:
  ...
  /jest-circus/29.5.0:
    jest-circus: private
  /jest-cli/29.5.0(@types/node@18.16.12)(ts-node@10.0.0):
    jest-cli: private
  /jest-config/29.5.0(@types/node@18.16.12)(ts-node@10.0.0):
    jest-config: private
  /jest-diff/29.5.0:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Mon, 12 Jun 2023 06:22:10 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped: []
storeDir: /Users/huangchao/.hvigor/caches/v3
